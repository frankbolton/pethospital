 var gameScore = function() {
	...
	return {
        ...
        drawScoreScreen: function () {
			...
			if (t_remaining>0&& !gameOver){
          	...
          	if (gameOver){
                ...
                context.textBaseline = "top";
                context.fillText  ("Score: "+score, 75, 10 );	
                context.fillText ("Game over, half your cats died. Press ", 300, 10);
        ...
        tick: function () {
            ...
            seconds = timer % 60;
            scoreVisible = false;
			//functionality for checking if less than half the stations are dead
		...
		gameOver: function(){
			gameOver = true;
			console.log("setting the Game Over state")
			return true;
		} 	
	};
}();
